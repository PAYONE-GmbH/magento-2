...
define(
    ...
    function (Component, messageList, $t) {
        ...
        return Component.extend({
            defaults: {
                template: 'Payone_Core/payment/trustly',
                bankCountry: '',
                iban: '',
                bic: ''
            },
            ...
            getCountries: function () {
                return window.checkoutConfig.payment.payone.trustlyCountries;
            },
            requestBic: function () {
                return window.checkoutConfig.payment.payone.trustlyRequestBic;
            },
