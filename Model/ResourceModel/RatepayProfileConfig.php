...
class RatepayProfileConfig extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    protected function getDataArray($aProfileResponse)
    {
        $aData = [
            ...
            'eligibility_ratepay_pq_light'          => isset($aProfileResponse['add_paydata[eligibility-ratepay-pq-light]']) ? $aProfileResponse['add_paydata[eligibility-ratepay-pq-light]'] : '',
