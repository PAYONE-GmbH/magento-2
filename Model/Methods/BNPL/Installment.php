...
class Installment extends BNPLBase
{
    /**
     * Payment method code
     *
     * @var string
     */
    protected $_code = PayoneConfig::METHOD_BNPL_INSTALLMENT;
     ...
     * @var string
     */
    protected $sSubType = self::METHOD_BNPL_SUBTYPE_INSTALLMENT;
    ...
    public function getSubTypeSpecificParameters(Order $oOrder)
    {
        ...
        $aParams = [
            ...
            'add_paydata[installment_option_id]' => $oInfoInstance->getAdditionalInformation('optionid'),
