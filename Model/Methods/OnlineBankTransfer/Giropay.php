...
/**
 * Model for Giropay payment method
 */
class Giropay extends OnlineBankTransferBase
{
    /**
     * Payment method code
     *
     * @var string
     */
    protected $_code = PayoneConfig::METHOD_OBT_GIROPAY;
     ...
     * @var string
     */
    protected $sSubType = self::METHOD_OBT_SUBTYPE_GIROPAY;
