...
/**
 * Model for Ratepay directdebit payment method
 */
class Directdebit extends RatepayBase
{
    /**
     * Payment method code
     *
     * @var string
     */
    protected $_code = PayoneConfig::METHOD_RATEPAY_DEBIT;
     ...
     * @var string
     */
    protected $sSubType = self::METHOD_RATEPAY_SUBTYPE_DEBIT;
